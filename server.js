...
var App = function App() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, "welcome to react ssr");
};
...
var ReactDOMServer = __webpack_require__(/*! react-dom/server */ "./node_modules/react-dom/server.js");

var App = __webpack_require__(/*! ./client/App */ "./client/App.js").default;
...
app.get('*', function (req, res) {
  ...
  fs.readFile(path.resolve(__dirname, 'public', 'index.html'), 'utf8', function (err, data) {
    if (err) {
      console.error('Something went wrong:', err);
      res.status(500).send('Oops, better luck next time!');
    }

    res.send(data.replace('<div id="root"></div>', "<div id=\"root\">".concat(app, "</div>")));
  });
});
